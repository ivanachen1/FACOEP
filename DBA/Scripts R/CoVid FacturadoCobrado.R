...
#wb <- createWorkbook()
#addWorksheet(wb, "Datos Facturado", gridLines = TRUE)
#writeData(wb, "Datos Facturado", Facturado, startCol = 1, startRow = 1, rowNames = FALSE)
#addWorksheet(wb, "Datos Cobrado", gridLines = TRUE)
#writeData(wb, "Datos Cobrado", Cobrado, startCol = 1, startRow = 1, rowNames = FALSE)
#saveWorkbook(wb, "FacturadoCobradoCoVid.xlsx", overwrite = TRUE)
